...
public class CatalogPage extends VBox implements Page {
    ...
    public CatalogPage(){
        ...
        CatalogItem item2= new CatalogItem("Десерты",new Image("/bul.png"));
        FlowPaneCatalogItems.add(item2,2,0);
        CatalogItem item3= new CatalogItem("Сэндвичи",new Image("/закуски 1.png"));
        FlowPaneCatalogItems.add(item3,3,0);
        //FlowPaneCatalogItems.getChildren().add(item3);
        CatalogItem item5= new CatalogItem("Завтраки",new Image("/zav.png"));
        FlowPaneCatalogItems.add(item5,0,1);
        CatalogItem item6= new CatalogItem("Бульоны",new Image("/bul.png"));
        FlowPaneCatalogItems.add(item6,1,1);
        CatalogItem item7= new CatalogItem("Десерты",new Image("/bul.png"));
        FlowPaneCatalogItems.add(item7,2,1);
        CatalogItem item8= new CatalogItem("Сэндвичи",new Image("/закуски 1.png"));
        FlowPaneCatalogItems.add(item8,3,1);
        //FlowPaneCatalogItems.getChildren().add(item3);
        System.out.println(FlowPaneCatalogItems.getChildren().size());
        ObservableList<String> sortlist= FXCollections.observableArrayList("1","2","3");
