...
public class CatalogPage extends VBox implements Page {
    ...
    private Scene load(){
        FXMLLoader fxmlLoader = new FXMLLoader(MyApplication.class.getResource("Spisok.fxml"));
    ...
    public CatalogPage(){
        ...
        CatalogItem item4= new CatalogItem("Завтраки",new Image("/com/example/javagroupproject1/images/zav.png"));
        FlowPaneCatalogItems.add(item4,0,0);
        CatalogItem item1= new CatalogItem("Бульоны",new Image("/com/example/javagroupproject1/images/bul.png"));
        FlowPaneCatalogItems.add(item1,1,0);
        CatalogItem item2= new CatalogItem("Закуски",new Image("/com/example/javagroupproject1/images/закуски 1.png"));
        FlowPaneCatalogItems.add(item2,2,0);
        CatalogItem item3= new CatalogItem("Сэндвичи",new Image("/com/example/javagroupproject1/images/сендвичи 1.png"));
        FlowPaneCatalogItems.add(item3,3,0);
        //FlowPaneCatalogItems.getChildren().add(item3);
        CatalogItem item5= new CatalogItem("Основные",new Image("/com/example/javagroupproject1/images/основные.png"));
        FlowPaneCatalogItems.add(item5,0,1);
        CatalogItem item6= new CatalogItem("Салаты",new Image("/com/example/javagroupproject1/images/салаты 1.png"));
        FlowPaneCatalogItems.add(item6,1,1);
        CatalogItem item7= new CatalogItem("Супы",new Image("/com/example/javagroupproject1/images/супы 1.png"));
        FlowPaneCatalogItems.add(item7,2,1);
        CatalogItem item8= new CatalogItem("Десерты",new Image("/com/example/javagroupproject1/images/десерты 1.png"));
